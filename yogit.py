...
urlLists = []
# RegEx blacklist 
blacklist = "(?!assets|articles|site|images|open_graph|features|business|_private|docs|integrations|modules|pricing|feature|browser|search|trending|topics|unicode|devops|icons|pulls|issues|marketplace|explore|organizations|new)"
